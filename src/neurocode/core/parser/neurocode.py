...
class NeuroCodeParser:
    ...
    def parse_intent_action(self) -> IntentNode:
        ...
        modifier = None
        if self.current_token and self.current_token.type in [TokenType.FOR, TokenType.FROM, TokenType.TO, TokenType.WITH]:
...
'''
    ...
    print("\n🔤 Tokenization:")
    lexer = NeuroCodeLexer(neurocode_source)
    tokens = lexer.tokenize()
