...
from core.llm_integration import neurocode_llm_integration
from core.multi_llm_manager import llm_manager
from core.neurocode_grammar import NeuroCodeAST, create_neurocode_parser
...
class NeuroCodeEngine:
    ...
    def _initialize_models(self):
        ...
        try:
            ...
            print(f"🧠 Initialized NeuroCode Engine with {len(available_models)} LLM models")
            ...
            if "gpt-3.5-turbo" in available_models:
                ...
                print("⚠️ No LLM models available - model/assistant statements will not work")

        except Exception as e:
            print(f"⚠️ Error initializing models: {e}")

    def execute_neurocode_file(self, file_path: str) -> Dict[str, Any]:
        """Execute a .neuro file and return results"""
        try:
    ...
    def _execute_goal_statement(self, statement: NeuroCodeAST) -> Dict[str, Any]:
        ...
        priority = statement.metadata.get("priority", "medium") if statement.metadata else "medium"
    ...
    def _execute_agent_statement(self, statement: NeuroCodeAST) -> Dict[str, Any]:
        ...
        if agent_command in ["on", "off"]:
            ...
            self.execution_context["agents"]["default"] = {"status": "on", "command": agent_command}
            return {
                "type": "agent",
                "status": "success",
    ...
    def _execute_remember_statement(self, statement: NeuroCodeAST) -> Dict[str, Any]:
        ...
        tag = statement.metadata.get("tag", "default") if statement.metadata else "default"
