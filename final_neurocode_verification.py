...
def main():
    ...
    print("1. Write NeuroCode programs with .neuro extension")
    print("2. Use the parser: from src.neurocode.core import create_parser")
    print("3. Use the interpreter: from src.neurocode.core import create_interpreter")
