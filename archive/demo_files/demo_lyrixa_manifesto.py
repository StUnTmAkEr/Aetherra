...
def test_manifesto_integration():
    ...
    try:
        ...
        print(
            f"🧠 Consciousness Awareness: {manager.get_personality_trait('consciousness_awareness')}"
        )
        print(
            f"🔄 Evolutionary Thinking: {manager.get_personality_trait('evolutionary_thinking')}"
        )
