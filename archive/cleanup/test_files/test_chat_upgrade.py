#!/usr/bin/env python3
"""
Test script for the upgraded Aetherra chat system
"""
...
def test_chat_router(demo_mode=True):
    try:
        ...
        test_messages = [
            "Hello there!",
            "Can you help me learn aetherra?",
        ...
        print(f"\n🧬 Testing Aetherra Chat Upgrade ({mode_str})")
        print("=" * 60)
            ...
            try:
                ...
                if isinstance(response, dict):
                    ...
                    if response.get("aetherra"):
                        print(f"🧬 aetherra: {response['aetherra']}")
...
if __name__ == "__main__":
    print("🧬 Aetherra Chat System Upgrade Test")
    print("=" * 50)
