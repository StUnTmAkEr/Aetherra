"""
AetherraCode Parser Subsystem
========================

Centralized parser functionality for the AetherraCode language.
...
def create_parser(enhanced=True):
    """Create a AetherraCode parser instance.
...
def parse_code(code: str, enhanced=True):
    """Parse AetherraCode source code."""
