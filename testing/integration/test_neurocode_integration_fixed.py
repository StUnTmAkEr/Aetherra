...
def test_cli_components():
    ...
    try:
        ...
        import neurocode.cli.main  # noqa: F401
...
def test_plugin_system():
    ...
    try:
        ...
        print(f"✅ Plugin system: Plugin manager working ({len(plugins)} plugins found)")
        return True
    except Exception as e:
...
def test_launcher_systems():
    ...
    try:
        ...
        print(f"✅ Launcher systems: {working_launchers}/{len(launchers)} launchers working")
...
def test_ui_systems():
    ...
    try:
        ...
        ui_modules = [
            "src.neurocode.ui.neuroplex_gui",
            "src.neurocode.ui.enhanced_neuroplex",
            "src.neurocode.ui.neuroplex_gui_v2",
            "src.neurocode.ui.neuroplex_fully_modular",
        ]
