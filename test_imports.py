...
def main():
    ...
    tests = [
        ("Basic aetherra_core import", "from Aetherra.aetherra_core import get_system_status"),
        ("Engine module import", "from Aetherra.aetherra_core.engine import get_engine_status"),
        ("Memory module import", "from Aetherra.aetherra_core.memory import MEMORY_AVAILABLE"),
        ("Config module import", "from Aetherra.aetherra_core.config import CONFIG_AVAILABLE"),
        ...
        ("Service registry import", "from aetherra_service_registry import ServiceRegistry"),
