...
from core.ai_runtime import (ask_ai, analyze_memory_patterns, analyze_user_behavior, 
...
class NeuroAgent:
    ...
    def get_command_type(self, line):
        ...
        elif line.startswith("load") or line.startswith("refactor") or line.startswith("apply") or line.startswith("backup") or line.startswith("diff"):
            return "self_editing"
        else:
            return "other"
