...
class ExecutionMode(Enum):
    """Execution modes for NeuroCode runtime"""
...
class ExecutionContext:
    """Runtime execution context for NeuroCode"""
...
class RuntimeEnvironment:
    """Global runtime environment for NeuroCode"""
    ...
    def _estimate_memory_usage(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'estimated_mb': (sys.getsizeof(self.contexts) + 
                           sum(sys.getsizeof(ctx) for ctx in self.contexts.values())) / 1024 / 1024
        }
