...
"""
    ...
    try:
        # Test lexer
        from src.neurocode.core.parser.parser import NeuroCodeLexer

        lexer = NeuroCodeLexer(neurocode_program)
        ...
        # Test parser
        from src.neurocode.core.parser.parser import NeuroCodeParser
        ...
        # Test compiler
        from src.neurocode.core.parser.parser import NeuroCodeCompiler

        compiler = NeuroCodeCompiler()
        compiled_code = compiler.compile(ast)

        print(f"  ✅ Compilation: Generated executable code ({len(compiled_code)} chars)")
...
def test_memory_system():
    ...
    try:
        ...
        from src.neurocode.core import create_memory_system
...
"""
    ...
    try:
        ...
        lexer = NeuroCodeLexer(demo_program)
        tokens = lexer.tokenize()
...
def main():
    ...
    all_results["demo"] = {"comprehensive_demo": "✅ SUCCESS" if demo_success else "❌ FAILED"}
