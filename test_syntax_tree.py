...
from core.syntax_tree import parse_neurocode, SyntaxTreeVisitor, analyze_syntax_tree
...
"""
    ...
    print(f"📈 Nested structure stats:")
    print(f"   Max depth: {stats['max_depth']}")
    print(f"   Total nodes: {stats['total_nodes']}")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"🎯 Enhanced parsing architecture is operational")
