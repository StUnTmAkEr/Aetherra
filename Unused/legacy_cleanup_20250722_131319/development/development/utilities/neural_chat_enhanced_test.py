...
print("🔧 DEBUG: Available lyrixa_agent attributes: ['conversation', 'chat', ...]")
print("🔧 DEBUG: Available conversation methods: ['generate_response', ...]")
