#!/usr/bin/env python3
"""
🧬 Aetherra Multi-LLM Integration Test
======================================

Test the new multi-LLM capabilities of Aetherra:
- Model switching with `model:` statements
- AI assistance with `assistant:` statements
- Integration with the Aetherra engine
"""
...
def test_multi_llm_parsing():
    ...
    print("🧬 Testing Multi-LLM Aetherra Parsing")
    print("=" * 50)
    ...
    try:
        ...
        # Test multi-LLM Aetherra
        multi_llm_code = """
# Multi-LLM Aetherra Test
...
def test_multi_llm_execution():
    ...
    try:
        ...
        try:
            ...
            print(f"⚠️ Aetherra engine not available: {e}")
            has_engine = False
            return False
...
model: gpt-3.5-turbo
assistant: "Hello from Aetherra multi-LLM system"
...
"""
        ...
        result = engine.execute_Aetherra(test_code)
...
def test_model_availability():
    ...
    try:
        from Aetherra.core.multi_llm_manager import llm_manager
...
def main():
    ...
    print("🧬 Aetherra Multi-LLM Integration Test Suite")
    print("=" * 60)
    #     print("Testing Aetherra's new multi-LLM capabilities...")
    print()
    ...
    if passed == total:
        print("🎉 ALL TESTS PASSED! Aetherra Multi-LLM integration is working!")
        print("\n🚀 Ready for:")
        ...
        print("   • Seamless model swapping in Aetherra programs")
    elif passed > 0:
