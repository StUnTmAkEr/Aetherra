...
class PluginPanelManager:
    ...
    def resize_panel(
        self, panel_name: str, new_width: int, new_height: Optional[int] = None
    ):
    ...
    def get_panel_state(self, panel_name: str) -> Dict[str, Any]:
        ...
        return self.panel_states.get(
            panel_name, {"collapsed": False, "width": 300, "position": "left"}
        )
    ...
    def get_collapsed_panels(self) -> List[str]:
        ...
        return [
            panel
            for panel, state in self.panel_states.items()
    ...
    def get_panel_dimensions(self, panel_name: str) -> Tuple[int, int]:
        ...
        return (state.get("width", 300), state.get("height", 400))
