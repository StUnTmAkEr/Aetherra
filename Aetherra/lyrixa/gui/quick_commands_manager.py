...
class QuickCommandsManager:
    ...
    def execute_command(self, command_id: str) -> bool:
        ...
        if command_id in self.commands:
            ...
            print(
                f"Executing custom command: {custom_command.get('label', command_id)}"
            )
            return True
    ...
    def add_to_favorites(self, command_id: str) -> bool:
        ...
        if (
            command_id in self.commands or command_id in self.custom_commands
        ) and command_id not in self.favorites:
