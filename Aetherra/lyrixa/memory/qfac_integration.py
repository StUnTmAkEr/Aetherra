...
class QFACMemoryNode:
    ...
    def _should_compress(self) -> bool:
        ...
        return (
            self.compression_score.compression_ratio > 2.0 and
            self.compression_score.access_frequency < 2.0  # Less than twice per day
        )
    ...
    async def compress(self) -> bool:
        ...
        try:
            ...
            self.compression_metadata = {
                ...
                "fidelity_level": self.compression_score.fidelity_level.value if self.compression_score else "unknown"
            }
            
            self.is_compressed = True
            print(f"✅ Compressed {self.node_id}: {self.compression_metadata['original_size']} → {self.compression_metadata['compressed_size']} bytes")
            return True
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "compression_score": self.compression_score.__dict__ if self.compression_score else None
        }
...
class QFACMemorySystem:
    ...
    async def get_system_status(self) -> Dict[str, Any]:
        ...
        total_compressed_size = sum(
            ...
            if node.compression_metadata else len(str(node.original_data))
        ...
        return {
            ...
            "node_statistics": {
                ...
                "compression_percentage": (compressed_nodes / total_nodes * 100) if total_nodes > 0 else 0
            },
            "size_statistics": {
    ...
    async def optimize_system(self) -> Dict[str, Any]:
        ...
        optimization_results["actions_taken"].append({
            "action": "compress_eligible_nodes",
        ...
        degraded_nodes = [
            ...
            if node.compression_score and node.compression_score.fidelity_level == FidelityLevel.DEGRADED
        ]
        ...
        if degraded_nodes:
            ...
            for node_id in degraded_nodes:
                ...
                if node.is_compressed:
                    ...
                    optimization_results["actions_taken"].append({
                        "action": "decompress_degraded_node",
                        "node_id": node_id
                    })
    ...
    test_data = [
        ...
        },
        {
            ...
            "data": {
                ...
                "relationships": [
                    {"from": "neural networks", "to": "consciousness", "type": "enables"},
                    {"from": "quantum computing", "to": "neural networks", "type": "accelerates"}
                ]
            }
        },
        {
            ...
            "data": {
                "events": [
                    ...
                    {"timestamp": 1640995800, "event": "Compression metrics implemented"},
