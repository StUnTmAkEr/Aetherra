...
try:
    from core.local_ai import LocalAIEngine, get_local_ai, local_ask_ai
...
try:
    from core.vector_memory import EnhancedSemanticMemory, VectorMemory
...
try:
    from core.intent_parser import IntentToCodeParser, IntentType
