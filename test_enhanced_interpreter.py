...
def test_enhanced_interpreter():
    """Test the enhanced interpreter with real NeuroCode examples"""

    if not HAS_INTERPRETER:
        print("⚠️ Cannot test - core interpreter not available")
        return

    print("🧬 Testing Enhanced NeuroCode Interpreter")
    print("=" * 60)
...
if __name__ == "__main__":
    ...
    print("✅ NeuroCode AI-native blocks (think, analyze, memory)")
    print("✅ Backward compatibility with existing NeuroCode")
